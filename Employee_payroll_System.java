...
abstract class Employee { // abstrct class ( abstraction)
    ...
    @Override // polymorphism, // method overirding // It looks like you've overridden the
              // toString() method for a class named Employee
    public String toString() { // The toString() method you've provided concatenates the values of the name,
                               // id, and the result of the calculateSalary() method into a string and returns
                               // it.
...
// ------------------------------------------------------------------------------------------------
class FullTimeEmployee extends Employee { // If a regular class extends an abstract class then that regular class must
    ...
    public FullTimeEmployee(String name, int id, double monthlySalary) { // constructor
        super(name, id); // dusre class se le rahe hai name or id islie super use ho raha hai // Super
                         // keyword is a reference variable which is used to refer immediate parent class
                         // object
...
// ------------------------------------------------------------------------------------------------
class PartTimeEmployee extends Employee { // If a regular class extends an abstract class then that regular class must
                                          // have to implement all the abstract method of parent abstract class .
...
class PayrollSystem { // sarra data leke store karega phir throw karega
    ...
    // It looks like you've declared a private List variable named employeeList of
    // type Employee.
    ...
    // list is similar to array only only differnece is that list incrase his memory
    // size when he is getting fulled
